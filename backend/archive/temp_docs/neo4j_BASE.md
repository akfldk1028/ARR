...
# Name of the default database. Can be changed with the 'dbms.setDefaultDatabase' procedure.
...
#dbms.cluster.endpoints=localhost:6000,localhost:6001,localhost:6002
...
# This is the setting to add to the collection of addresses in dbms.cluster.endpoints.
...
# Netty resources leak detection.
# Possible values are DISABLED, SIMPLE, ADVANCED, PARANOID. Ignores case.
# For more details please refer to the netty documentation
...
# Name of the service
server.windows_service_name=neo4j-relate-dbms-23e9404b-8efc-4706-adc0-90e1c20445ab

#********************************************************************
# Other Neo4j system properties
#********************************************************************

db.shutdown_transaction_end_timeout=5s
internal.db.transaction.shutdown_terminated_transaction_wait_timeout=5s
