...
import { useLogStore, useUI, useSettings } from '@/google/lib/state';

import { useLiveAPIContext } from '@/google/contexts/LiveAPIContext';
      ...
      <nav className={cn('actions-nav', { 'text-entry-visible-landscape': isLandscape && isTextEntryVisible })}>
        <button
          ...
          className={cn(
            ...
            'hover:bg-transparent hover:border-gray-700',
            'focus:outline-none focus:ring-2 focus:ring-gray-300',
            {
              'bg-blue-900 text-blue-500 border-blue-500': connected,
              'hover:border-blue-500': connected,
            }
          )}
