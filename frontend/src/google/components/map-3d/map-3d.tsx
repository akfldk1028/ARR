...
export const Map3D = forwardRef(
  (
    ...
    // Set camera properties directly as properties, not attributes
    useDeepCompareEffect(() => {
      if (!map3DElement) return;
    ...
    }, [map3DElement, center, range, heading, tilt, roll]);
    ...
    return (
      <gmp-map-3d
        ref={map3dRef}
        // Camera properties are set via useEffect, not as JSX attributes
        // to avoid React converting objects to "[object Object]" strings
